...
//WebUI.click(findTestObject('Object Repository/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/span_t'))
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/span_t'), 
    0)
